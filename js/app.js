(() => {
    ...
    function initSliders() {
        if (document.querySelector(".entr-text__slider")) {
            let textSlider = new core(".entr-text__slider", {
                modules: [ Controller ],
                direction: "vertical",
                observer: true,
                observeParents: true,
            ...
            if (document.querySelector(".entr-image__slider")) {
                new core(".entr-image__slider", {
                    modules: [ Autoplay ],
                    modules: [ Pagination ],
                    modules: [ Controller ],
                    observer: true,
